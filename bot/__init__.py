...
try:
    ...
    GITHUB_USER_NAME = getConfig('GITHUB_USER_NAME')
    GITHUB_TOKEN = getConfig('GITHUB_TOKEN')
    GITHUB_DUMPER_REPO_NAME = getConfig('GITHUB_DUMPER_REPO_NAME')
    GITHUB_DUMMY_REPO_NAME = getConfig('GITHUB_DUMMY_REPO_NAME')
    TELEGRAM_CHANNEL_NAME = getConfig('TELEGRAM_CHANNEL_NAME')
    DUMPER_REPO_WORKFLOW_URL = getConfig('DUMPER_REPO_WORKFLOW_URL')
    GITHUB_ORG_NAME = getConfig('GITHUB_ORG_NAME')
    GITHUB_USER_EMAIL = getConfig('GITHUB_USER_EMAIL')
